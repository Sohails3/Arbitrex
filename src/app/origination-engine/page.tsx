  ...
  return (
    <>
      <PageHeader
        ...
        title="Private Equity Origination Engine"
        intro="One of the tools we have built. It answers a single question for an origination team — which companies fit our mandate, and what moved this week — by working the companies register directly rather than handing back another export."
      />
